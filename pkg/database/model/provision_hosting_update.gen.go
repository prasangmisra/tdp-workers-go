...
const TableNameProvisionHostingUpdate = "provision_hosting_update"

// ProvisionHostingUpdate mapped from table <provision_hosting_update>
type ProvisionHostingUpdate struct {
...
// TableName ProvisionHostingUpdate's table name
func (*ProvisionHostingUpdate) TableName() string {
	return TableNameProvisionHostingUpdate
}
