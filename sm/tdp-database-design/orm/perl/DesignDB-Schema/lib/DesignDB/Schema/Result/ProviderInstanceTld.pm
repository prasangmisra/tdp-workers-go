use utf8;
package DesignDB::Schema::Result::ProviderInstanceTld;
...
=head1 TABLE: C<provider_instance_tld>

=cut 

__PACKAGE__->table("provider_instance_tld");
...
__PACKAGE__->has_many(
  ...
  { "foreign.provider_instance_tld_id" => "self.id" },
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:NB+nvTFj91MdeM1gHNQsug
