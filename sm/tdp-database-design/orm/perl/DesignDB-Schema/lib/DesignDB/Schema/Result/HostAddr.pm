use utf8;
package DesignDB::Schema::Result::HostAddr;
...
=head1 TABLE: C<host_addr>

=cut 

__PACKAGE__->table("host_addr");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:pe4no/6OTFwmoVtIvS6iLw
