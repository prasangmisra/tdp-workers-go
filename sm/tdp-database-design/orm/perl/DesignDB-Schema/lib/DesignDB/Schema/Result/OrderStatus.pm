use utf8;
package DesignDB::Schema::Result::OrderStatus;
...
__PACKAGE__->add_unique_constraint("order_status_name_key", ["name"]);

=head1 RELATIONS

=head2 order_status_transitions_from
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:S5hffJl9gXMkst/6icnahg
