use utf8;
package DesignDB::Schema::Result::OrderItemObject;
...
=head1 TABLE: C<order_item_object>

=cut 

__PACKAGE__->table("order_item_object");
...
=head2 C<order_item_object_name_key>
...
__PACKAGE__->add_unique_constraint("order_item_object_name_key", ["name"]);
...
__PACKAGE__->has_many(
  ...
  { "foreign.order_item_object_id" => "self.id" },
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:oXp4L6MBv/XfN4/pJA2f2Q
