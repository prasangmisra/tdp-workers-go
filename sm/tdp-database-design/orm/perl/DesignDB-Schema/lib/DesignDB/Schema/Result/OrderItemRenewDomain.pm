use utf8;
package DesignDB::Schema::Result::OrderItemRenewDomain;
...
=head1 TABLE: C<order_item_renew_domain>

=cut 

__PACKAGE__->table("order_item_renew_domain");
...
=head2 renew_domain_plans

Type: has_many

Related object: L<DesignDB::Schema::Result::RenewDomainPlan>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:TCOFYF5SVdHTPJJ39FPmlg
