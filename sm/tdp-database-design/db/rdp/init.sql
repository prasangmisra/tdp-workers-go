...
WITH domain_de AS (
    ...
    VALUES ('registrant', 'Data element related to registrant contact', (SELECT id FROM domain_de))
    RETURNING id
), admin_de AS (
    INSERT INTO data_element (name, descr, parent_id)
    VALUES ('admin', 'Data element related to admin contact', (SELECT id FROM domain_de))
    RETURNING id
), tech_de AS (
    INSERT INTO data_element (name, descr, parent_id)
    VALUES ('tech', 'Data element related to tech contact', (SELECT id FROM domain_de))
    RETURNING id
), billing_de AS (
    INSERT INTO data_element (name, descr, parent_id)
    VALUES ('billing', 'Data element related to billing contact', (SELECT id FROM domain_de))
    RETURNING id
)
INSERT INTO data_element (name, descr, parent_id)
VALUES
    ...
    ('phone_ext', 'Phone extension of the registrant', (SELECT id FROM registrant_de)),
    ...
    ('fax_ext', 'Fax extension of the registrant', (SELECT id FROM registrant_de)),
    ...
    ('phone_ext', 'Phone extension of the admin contact', (SELECT id FROM admin_de)),
    ...
    ('fax_ext', 'Fax extension of the admin contact', (SELECT id FROM admin_de)),
    ...
    ('phone_ext', 'Phone extension of the tech contact', (SELECT id FROM tech_de)),
    ...
    ('fax_ext', 'Fax extension of the tech contact', (SELECT id FROM tech_de)),
    ...
    ('phone_ext', 'Phone extension of the billing contact', (SELECT id FROM billing_de)),
    ...
    ('fax_ext', 'Fax extension of the billing contact', (SELECT id FROM billing_de)),
