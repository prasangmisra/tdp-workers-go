...
ALTER TABLE history.secdns_key_data
ADD COLUMN orig_id UUID;

ALTER TABLE history.secdns_key_data
ALTER COLUMN id SET DEFAULT gen_random_uuid();

ALTER TABLE history.secdns_ds_data
ADD COLUMN orig_id UUID;

ALTER TABLE history.secdns_ds_data
ALTER COLUMN id SET DEFAULT gen_random_uuid();

ALTER TABLE history.domain_secdns
ALTER COLUMN id SET DEFAULT gen_random_uuid();

ALTER TABLE history.domain_contact
ALTER COLUMN id SET DEFAULT gen_random_uuid();

ALTER TABLE history.contact_attribute
ALTER COLUMN id SET DEFAULT gen_random_uuid();

ALTER TABLE history.domain_host
ALTER COLUMN id SET DEFAULT gen_random_uuid();

ALTER TABLE history.host_addr 
ALTER COLUMN id SET DEFAULT gen_random_uuid();
