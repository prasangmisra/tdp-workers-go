-- Adding ssl_verify column to epp settings to disable checking if a cert is signed by 
-- a known CA and not expired, specifically for test connections.

ALTER TABLE class.epp_setting ADD COLUMN IF NOT EXISTS ssl_verify BOOLEAN;
