CREATE TABLE IF NOT EXISTS escrow.escrow_data_enom (
...
CREATE TABLE IF NOT EXISTS escrow.escrow_data_opensrs (
    domain_name       TEXT NOT NULL,                                       -- Domain Name
    expiry_date       TIMESTAMPTZ,                                         -- Expiration Date
    nameservers       TEXT,                                                -- List of Domain Nameservers
    rt_first_name     TEXT,                                                -- Registrant First Name
...
ALTER TABLE IF EXISTS escrow.escrow
    RENAME COLUMN step TO step_id;
