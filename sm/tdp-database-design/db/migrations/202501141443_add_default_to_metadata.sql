...
ALTER TABLE public.order_item_create_domain DISABLE TRIGGER validate_period_tg;
UPDATE public.order_item_create_domain SET metadata = '{}'::JSONB WHERE metadata IS NULL;
ALTER TABLE public.order_item_create_domain ENABLE TRIGGER validate_period_tg;
...
ALTER TABLE public.order_item_transfer_away_domain DISABLE TRIGGER order_prevent_if_domain_with_auth_info_does_not_exist_tg;
ALTER TABLE public.order_item_transfer_away_domain DISABLE TRIGGER validate_auth_info_tg;
UPDATE public.order_item_transfer_away_domain SET metadata = '{}'::JSONB WHERE metadata IS NULL;
ALTER TABLE public.order_item_transfer_away_domain ENABLE TRIGGER order_prevent_if_domain_with_auth_info_does_not_exist_tg;
ALTER TABLE public.order_item_transfer_away_domain ENABLE TRIGGER validate_auth_info_tg;
