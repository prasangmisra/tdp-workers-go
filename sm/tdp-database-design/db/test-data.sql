...
domain_registrant_tld AS (
    INSERT INTO domain_data_element (data_element_id, tld_id) VALUES (
        (SELECT id FROM v_data_element WHERE full_name = 'domain.registrant'),
        (SELECT id FROM tld_id)
    ) RETURNING id
),
domain_admin_tld AS (
    INSERT INTO domain_data_element (data_element_id, tld_id) VALUES (
        (SELECT id FROM v_data_element WHERE full_name = 'domain.admin'),
        (SELECT id FROM tld_id)
    ) RETURNING id
),
domain_tech_tld AS (
    INSERT INTO domain_data_element (data_element_id, tld_id) VALUES (
        (SELECT id FROM v_data_element WHERE full_name = 'domain.tech'),
        (SELECT id FROM tld_id)
    ) RETURNING id
),
domain_billing_tld AS (
    INSERT INTO domain_data_element (data_element_id, tld_id) VALUES (
        (SELECT id FROM v_data_element WHERE full_name = 'domain.billing'),
        (SELECT id FROM tld_id)
    ) RETURNING id
)
...
VALUES
    (
        (SELECT id FROM domain_registrant_tld),
        tc_id_from_name('permission', 'must_collect')
    ),
    (
        (SELECT id FROM domain_admin_tld),
        tc_id_from_name('permission', 'must_collect')
    ),
    (
        (SELECT id FROM domain_tech_tld),
        tc_id_from_name('permission', 'must_collect')
    ),
    (
        (SELECT id FROM domain_billing_tld),
...
billing_email_tld AS (
    INSERT INTO domain_data_element (data_element_id, tld_id) VALUES (
        (SELECT id FROM v_data_element WHERE full_name = 'billing.email'),
        (SELECT id FROM tld_id)
    ) RETURNING id
),
billing_first_name_tld AS (
    INSERT INTO domain_data_element (data_element_id, tld_id) VALUES (
        (SELECT id FROM v_data_element WHERE full_name = 'billing.first_name'),
        (SELECT id FROM tld_id)
    ) RETURNING id
),
billing_last_name_tld AS (
    INSERT INTO domain_data_element (data_element_id, tld_id) VALUES (
        (SELECT id FROM v_data_element WHERE full_name = 'billing.last_name'),
        (SELECT id FROM tld_id)
    ) RETURNING id
)
INSERT INTO domain_data_element_permission (domain_data_element_id, permission_id)
VALUES
    ...
    (
        (SELECT id FROM billing_email_tld),
        tc_id_from_name('permission', 'may_collect')
    ),
    (
        (SELECT id FROM billing_email_tld),
    ...
    (
        (SELECT id FROM billing_first_name_tld),
        tc_id_from_name('permission', 'must_collect')
    ),
    (
        (SELECT id FROM billing_last_name_tld),
        tc_id_from_name('permission', 'must_not_collect')
    ),
    (
        (SELECT id FROM billing_email_tld),
