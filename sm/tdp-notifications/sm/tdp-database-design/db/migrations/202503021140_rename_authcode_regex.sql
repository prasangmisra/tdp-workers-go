-- Delete the old attribute key in the attr_key table
DELETE FROM attr_key
WHERE name = 'authcode_acceptance_criteria' AND default_value = '.*';

-- Rename the attribute key in the attr_key table
UPDATE attr_key
SET name = 'authcode_regex'
WHERE name = 'authcode_acceptance_criteria';
