ALTER TABLE IF EXISTS domain ADD COLUMN IF NOT EXISTS tags TEXT[];
ALTER TABLE IF EXISTS domain ADD COLUMN IF NOT EXISTS metadata JSONB;

CREATE INDEX IF NOT EXISTS domain_tags_idx ON domain USING GIN(tags);
CREATE INDEX IF NOT EXISTS domain_metadata_idx ON domain USING GIN(metadata);

ALTER TABLE IF EXISTS host ADD COLUMN IF NOT EXISTS tags TEXT[];
ALTER TABLE IF EXISTS host ADD COLUMN IF NOT EXISTS metadata JSONB;

CREATE INDEX IF NOT EXISTS host_tags_idx ON host USING GIN(tags);
CREATE INDEX IF NOT EXISTS host_metadata_idx ON host USING GIN(metadata);

ALTER TABLE IF EXISTS order_item_create_domain ADD COLUMN IF NOT EXISTS tags TEXT[];
ALTER TABLE IF EXISTS order_item_create_domain ADD COLUMN IF NOT EXISTS metadata JSONB;

ALTER TABLE IF EXISTS provision_domain ADD COLUMN IF NOT EXISTS tags TEXT[];
ALTER TABLE IF EXISTS provision_domain ADD COLUMN IF NOT EXISTS metadata JSONB;
