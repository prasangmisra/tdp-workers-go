use utf8;
package DesignDB::Schema::Result::CreateDomainPlan;
...
=head1 TABLE: C<create_domain_plan>

=cut 

__PACKAGE__->table("create_domain_plan");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:hY5HxDiwK9cwr6grFHCwyg
