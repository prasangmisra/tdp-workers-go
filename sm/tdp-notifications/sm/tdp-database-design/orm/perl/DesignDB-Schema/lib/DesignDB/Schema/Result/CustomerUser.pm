use utf8;
package DesignDB::Schema::Result::CustomerUser;
...
=head2 C<customer_user_customer_id_user_id_key>
...
__PACKAGE__->add_unique_constraint(
  "customer_user_customer_id_user_id_key",
  ["customer_id", "user_id"],
);
...
__PACKAGE__->has_many(
  ...
  { "foreign.customer_user_id" => "self.id" },
...
Related object: L<DesignDB::Schema::Result::User>

=cut 

__PACKAGE__->belongs_to(
  "user",
  "DesignDB::Schema::Result::User",
  { id => "user_id" },
  { is_deferrable => 0, on_delete => "NO ACTION", on_update => "NO ACTION" },
);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:oJdRO7IMAUb1sioAtaY+sg
