use utf8;
package DesignDB::Schema::Result::ProvisionHost;
...
=head1 TABLE: C<provision_host>

=cut 

__PACKAGE__->table("provision_host");
...
=head2 C<provision_host_host_id_accreditation_id_key>
...
__PACKAGE__->add_unique_constraint(
  "provision_host_host_id_accreditation_id_key",
  ["host_id", "accreditation_id"],
);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:A+E1bjMEY50nj0QcQpNb9w
