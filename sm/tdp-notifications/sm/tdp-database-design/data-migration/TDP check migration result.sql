...
and tld_name in  ('feedback', 'forum','cloud','hiphop','love','music','locker',
	'click', 'country', 'diy', 'food', 'gift', 'juegos', 'lifestyle', 'link', 'living', 'property', 'sexy', 'vana');
...
CASE WHEN CAST(deldate AS date) <'2022-01-15' THEN     (deldate  + interval '7 hour') 
    ...
    END     as deldate
FROM dm_enom.domainname WHERE  itdp_domain_id IS NOT NULL  AND tld in  ('feedback', 'forum','cloud','hiphop','love','music','locker',
	'click', 'country', 'diy', 'food', 'gift', 'juegos', 'lifestyle', 'link', 'living', 'property', 'sexy', 'vana') 
...
WHERE substring(name,POSITION ('.' IN name)+1,20) in  ('feedback', 'forum','cloud','hiphop','love','music','locker',
	'click', 'country', 'diy', 'food', 'gift', 'juegos', 'lifestyle', 'link', 'living', 'property', 'sexy', 'vana');
...
WHERE   itdp_host_id IS NOT NULL   AND n.tld in  ('feedback', 'forum','cloud','hiphop','love','music','locker',
	'click', 'country', 'diy', 'food', 'gift', 'juegos', 'lifestyle', 'link', 'living', 'property', 'sexy', 'vana')
EXCEPT 
...
WHERE substring(d.name,POSITION ('.' IN d.name)+1,20) in  ('feedback', 'forum','cloud','hiphop','love','music','locker',
	'click', 'country', 'diy', 'food', 'gift', 'juegos', 'lifestyle', 'link', 'living', 'property', 'sexy', 'vana');
...
WHERE  n.tld in  ('feedback', 'forum','cloud','hiphop','love','music','locker',
	'click', 'country', 'diy', 'food', 'gift', 'juegos', 'lifestyle', 'link', 'living', 'property', 'sexy', 'vana')
EXCEPT 
SELECT h.name,d.name FROM  only public.host h
JOIN only public.domain_host dh ON dh.host_id =h.id
...
SELECT  dns.name ,d.slddottld  
	...
	CROSS JOIN dns
	WHERE d.tld  in  ('feedback', 'forum','cloud','hiphop','love','music','locker',
	'click', 'country', 'diy', 'food', 'gift', 'juegos', 'lifestyle', 'link', 'living', 'property', 'sexy', 'vana')  AND d.itdp_domain_id IS NOT NULL AND
	d.NSStatus = 'Yes' AND NOT EXISTS (SELECT 1 FROM dm_enom.nameservers h1 where h1.tld in  ('feedback', 'forum','cloud','hiphop','love','music','locker',
	'click', 'country', 'diy', 'food', 'gift', 'juegos', 'lifestyle', 'link', 'living', 'property', 'sexy', 'vana') and h1.domainnameid=d.domainnameid))
EXCEPT 
...
FROM dm_enom.contact WHERE itdp_contact_id IS NOT NULL  AND tld in  ('feedback', 'forum','cloud','hiphop','love','music','locker',
	'click', 'country', 'diy', 'food', 'gift', 'juegos', 'lifestyle', 'link', 'living', 'property', 'sexy', 'vana')
EXCEPT 
SELECT c.id,c.email, 
...
WHERE  tenant_name='enom'  AND substring(d.name,POSITION ('.' IN d.name)+1,20) in  ('feedback', 'forum','cloud','hiphop','love','music','locker',
	'click', 'country', 'diy', 'food', 'gift', 'juegos', 'lifestyle', 'link', 'living', 'property', 'sexy', 'vana');
...
WHERE tld in  ('feedback', 'forum','cloud','hiphop','love','music','locker',
	'click', 'country', 'diy', 'food', 'gift', 'juegos', 'lifestyle', 'link', 'living', 'property', 'sexy', 'vana') 
...
and substring(d.name,POSITION ('.' IN d.name)+1,20) in  ('feedback', 'forum','cloud','hiphop','love','music','locker',
	'click', 'country', 'diy', 'food', 'gift', 'juegos', 'lifestyle', 'link', 'living', 'property', 'sexy', 'vana');
...
WHERE substring(d.name,POSITION ('.' IN d.name)+1,20) in ('feedback', 'forum','cloud','hiphop','love','music','locker',
	'click', 'country', 'diy', 'food', 'gift', 'juegos', 'lifestyle', 'link', 'living', 'property', 'sexy', 'vana')  order by 1,2;
...
SELECT substring(d.name,POSITION ('.' IN d.name)+1,20) as tld,d.name as domain_name, h.name as host_name  FROM only public.host h --650
	...
	join itdp.domain id on id.id=d.id
	WHERE substring(d.name,POSITION ('.' IN d.name)+1,20)in ('feedback', 'forum','cloud','hiphop','love','music','locker',
	'click', 'country', 'diy', 'food', 'gift', 'juegos', 'lifestyle', 'link', 'living', 'property', 'sexy', 'vana') order by 1,2,3;
...
JOIN  itdp.domain id ON id.id=d.id and id.tld in ('feedback', 'forum','cloud','hiphop','love','music','locker',
	'click', 'country', 'diy', 'food', 'gift', 'juegos', 'lifestyle', 'link', 'living', 'property', 'sexy', 'vana') and dm_source='enom'
JOIN public.v_accreditation_tld vat ON vat.accreditation_tld_id=d.accreditation_tld_id
WHERE  tenant_name='enom'  AND substring(d.name,POSITION ('.' IN d.name)+1,20)  in ('feedback', 'forum','cloud','hiphop','love','music','locker',
	'click', 'country', 'diy', 'food', 'gift', 'juegos', 'lifestyle', 'link', 'living', 'property', 'sexy', 'vana') order by 1,2,3;
